          ...
          <div class="grid">         
              ...
              <div class="cells padding5">                             
                ...
                <div class="col-sm-offset-3 col-sm-8">            
                    <?= form_button(array(
                    	'id' => 'registro',                    
                        'content' => '<span class="mif-user-check glyphicon glyphicon-check"></span> ' . $this->lang->line('cms_general_label_button_save'),
                        'type' => 'submit', 
                        'data-theme'=>"b",
                    ...
                    <?= form_button(array(
                    	'id' => 'home',
                        'content' => '<span class="mif-home glyphicon glyphicon-home"></span> ' . $this->lang->line('cms_general_label_button_home'),
                        'type' => 'button', 
                        'data-theme'=>"b",
                        'class' => 'btn btn-primary button success'
                    )) ?>
