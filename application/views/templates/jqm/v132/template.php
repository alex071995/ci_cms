...
<html lang="en">
    ...
    <body>
       ...
       <div data-role="page" id="page"  data-quicklinks="true" class="jqm-demos">
         ...
         <div id="header" data-role="header" class="jqm-header" data-position="fixed" >
            ...
            <h1 class="jqm-logo">
            	...
            	<a style="padding-top: 5px;" href="#menu" class="jqm-navmenu-link" data-icon="bars" data-iconpos="notext">Menu</a>
				<a href="#" class="jqm-search-link" data-icon="search" data-iconpos="notext">Buscar</a>
        ...
        <div data-role="content" id="content" class="jqm-content">
       ...
       <div data-role="panel" id="menu" data-theme="b">
       		<?php       			 
				 //print_r($CI->config->item('navigation')); exit;
       			 $menu = '<ul data-role="listview" data-theme="d" data-divider-theme="d" data-icon="false" data-global-nav="demos" class="jqm-list">
